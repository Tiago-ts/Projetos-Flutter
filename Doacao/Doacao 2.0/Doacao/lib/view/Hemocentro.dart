...
class _HemocentroState extends State<Hemocentro> {
  ...
  List<String> itensMenu = ["Configurações", "Atualizar endereço","Requisições", "Deslogar" ];
  ...
  _chamarDoador() async {
    ...
    if ( usuarioLogado != null) {
     ...
     // String endereco = dados["endereco"];
      ...
      //print( "resultadoteste cidade " ,  numero);
...
/*
  ...
  */
        ...
        enderecoConfirmacao += "\n Rua: " + destino.rua + ", Nº " + destino.numero;
  ...
  _cancelarDoacao() async {
    ...
    db.collection("requisicoes")
        ...
        .updateData({"status": StatusRequisicao.CANCELADA
        }).then((_) {
